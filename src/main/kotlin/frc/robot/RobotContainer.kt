...
class RobotContainer {
    ...
    val leftEncoder = Encoder(Constants.leftEncoderPortA, Constants.leftEncoderPortB)
    val rightEncoder = Encoder(Constants.rightEncoderPortA, Constants.rightEncoderPortB)
    val gyro = AHRS()

    val drivetrain = DrivetrainSubsystem(motorsLeft,motorsRight, gyro, leftEncoder,rightEncoder)
